...
var RequestModule = (function (options, eventEmitter) {
  ...
  var handlers = options.handlers,
      ...
      overrideParseRequestObject = !!(handlers && handlers.parseRequestObject);

  this.parseRequestObject = function (req) {
    return this._parseRequestObject(req);
  };

  this._fallbackParseRequestObject = function(req){
  ...
  // The internal method can be overridden in the options.handlers key-value object.
  this._parseRequestObject = overrideParseRequestObject ? handlers.parseRequestObject
                                                    : this._fallbackParseRequestObject;
