...
var util         = require('util'),
    ...
    friendwares  = require('connect-friendwares'), // See [connect-friendwares](http://github.com/sebinsua/connect-friendwares).
    EventEmitter = require('events').EventEmitter;

// Grab internal modules used by the middleware.
var helpers       = require('./core/helpers'), // See [lib/core/helpers](http://sebinsua.github.io/express-keenio/helpers.html).
    optionsParser = require('./core/options-parser'); // See [lib/core/options-parser](http://sebinsua.github.io/express-keenio/options-parser.html).

var RoutesModule          = require('./routes'), // See [lib/routes](http://sebinsua.github.io/express-keenio/routes.html).
    ProxyResponseModule   = require('./parse/proxy-response'), // See [lib/parse/proxy-response](http://sebinsua.github.io/express-keenio/proxy-response.html).
    RequestModule         = require('./parse/request'), // See [lib/parse/request](http://sebinsua.github.io/express-keenio/request.html).
    IdentifyModule        = require('./parse/identify'), // See [lib/parse/identify](http://sebinsua.github.io/express-keenio/identify.html).
    EventCollectionModule = require('./event-collection'), // See [lib/event-collection](http://sebinsua.github.io/express-keenio/event-collection.html).
    KeenEventModule       = require('./keen-event'); // See [lib/keen-event](http://sebinsua.github.io/express-keenio/keen-event.html).
